view: querymetrics {
  ...
  measure: gas_guage_colorful {
    ...
    html:   <img src="https://chart.googleapis.com/chart?chs=200x125&cht=gom&chma=10,0,0,0&chxt=y&chds=0,13&chxr=0,10&chxl=0:|slow|fast&chco=FF0000,FF8040,FFFF00,00FF00&chf=bg,s,FFFFFF00&&chd=t:{{ value }}&chl={{ rendered_value }}">;;
  }
  ...
  measure: gas_guage_grey {
    ...
    html:   <img src="https://chart.googleapis.com/chart?chs=200x125&cht=gom&chma=10,0,0,0&chxt=y&chds=0,13&chxr=0,10&chxl=0:|slow|fast&chco=696969,808080,A9A9A9,C0C0C0,D3D3D3,DCDCDC&chf=bg,s,FFFFFF00&&chd=t:{{ value }}&chl={{ rendered_value }}">;;
